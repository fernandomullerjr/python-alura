...
# A variável será inicializada com 0, faremos um if para verificar o nível escolhido
#  se o ele for fácil, o usuário terá 20 tentativas, 
# se for médio terá 10
# e se for difícil terá 5 tentativas
