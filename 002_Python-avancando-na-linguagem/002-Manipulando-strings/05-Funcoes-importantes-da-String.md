...
- Funções de string podem ajudar a manipular entradas em formato string.
- Usando as funções str.strip() e str.upper(), podemos remover espaços em branco e deixar os caracteres no formato maiusculo.